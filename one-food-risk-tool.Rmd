...
updated_data <- reactive({
  ...
  if(input$type == "Overview"){
    ...
    if(input$pillar == "Animal/plant health"){
      hazard_scores$user[Pillar == "Animal/plant health"][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    } else if(input$pillar == "Animal/plant health" &&
              input$impact == input$input_sector[1]){
      hazard_scores$user[Impact == input$input_sector[1]][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    } else if(input$pillar == "Environmental health" &&
              input$impact == "Overview"){
      hazard_scores$user[Pillar == "Environmental health"][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    } else if(input$pillar == "Human health"){
      hazard_scores$user[Pillar == "Human health"][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    } else if(input$pillar == "Environmental health" &&
              input$impact == "Species richness"){
      hazard_scores$user[Impact == "Species richness"][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    } else if(input$pillar == "Environmental health" &&
              input$impact == "Pollution"){
      hazard_scores$user[Impact == "Pollution"][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    } else if(input$pillar == "Environmental health" &&
              input$impact == "Carbon footprint"){
      hazard_scores$user[Impact == "Carbon footprint"][, .(Score = sum(Score)), by = c("Hazard", "Impact")]
    }
  }
})

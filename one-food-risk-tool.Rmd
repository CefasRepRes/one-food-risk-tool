...
of_plot <- reactive({
  ...
  if(input$type == "Overview"){
    bar <- ggplot(data = updated_data()) +
      geom_bar(aes(x = Hazard, y = Score, fill = Pillar,
                   col = Pillar),
               stat = "identity",
               position = "stack",
               alpha = 0.8) +
    ...
    spider <- ggplot(data = updated_data(),
                     aes(x = Hazard, y = Score, col = Pillar, group = Pillar,
                         fill = Pillar)) +
    ...
    bar <- ggplot(data = updated_data()) +
      geom_bar(aes(x = Hazard, y = Score, fill = Impact,
                   col = Impact),
               stat = "identity",
               position = "stack",
               alpha = 0.8) +
      ...
      theme(legend.position = "bottom",
            text = element_text(size = 15))
    spider <- ggplot(data = updated_data(),
                     aes(x = Hazard, y = Score, col = Impact, group = Impact,
                         fill = Impact)) +
      geom_polygon(alpha = 0, linewidth = 1) +
      geom_point(size = 5) +
      scale_y_continuous(limits = c(0, NA)) +
